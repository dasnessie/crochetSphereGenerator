...
function testHelpers() {
  ...
  testSuccessful *= displayFailedTest(
    "makeHtmlList",
    makeHtmlList([["test", "test-label"]]) ===
      '<li aria-label="test-label">test</li>',
    "one element"
  );
  testSuccessful *= displayFailedTest(
    "makeHtmlList",
    makeHtmlList([
      ...
      '<li aria-label="test1-label">test1</li>' +
        '<li aria-label="test2-label">test2</li>' +
        '<li aria-label="test3-label">test3</li>',
    "three elements"
  );
...
function testPatternGenerator() {
  ...
  patternTestResult *=
    pattern.body[0][0] === "Magic ring, 4 sc, join. Ch 1. (4)";
  patternTestResult *=
    pattern.body[0][1] ===
  ...
  patternTestResult *=
    pattern.body[0][1] === "Magic ring, 4 single crochet. 4 stitches total.";
  patternTestResult *= pattern.body[1][0] === "3 sc, 1 inc. (5)";
  patternTestResult *=
    pattern.body[1][1] === "3 single crochet, 1 increase. 5 stitches total.";
  patternTestResult *= pattern.body[2][0] === "3 sc, 1 dec. (4)";
  patternTestResult *=
    pattern.body[2][1] === "3 single crochet, 1 decrease. 4 stitches total.";
  patternTestResult *=
    pattern.body[3][0] ===
    "Stuff the sphere if desired. Weave a thread through all the stitches " +
      "and pull tight to finish.";
  ...
  patternBodyTestResult *=
    patternBody[0][0] === "Magic ring, 4 sc, join. Ch 1. (4)";
  patternBodyTestResult *=
    patternBody[0][1] ===
    "Magic ring, 4 single crochet, join. Chain 1. 4 stitches total.";
  ...
  patternBodyTestResult *=
    patternBody[0][1] === "Magic ring, 4 single crochet. 4 stitches total.";
  patternBodyTestResult *= patternBody[1][0] === "3 sc, 1 inc. (5)";
  patternBodyTestResult *=
    patternBody[1][1] === "3 single crochet, 1 increase. 5 stitches total.";
  patternBodyTestResult *= patternBody[2][0] === "3 sc, 1 dec. (4)";
  patternBodyTestResult *=
    patternBody[2][1] === "3 single crochet, 1 decrease. 4 stitches total.";
  patternBodyTestResult *=
    patternBody[3][0] ===
    "Stuff the sphere if desired. Weave a thread through all the stitches " +
      "and pull tight to finish.";
  ...
  testSuccessful *= displayFailedTest(
    "Generate first row",
    generateFirstRow(42, sc, true)[0] === "Magic ring, 42 sc, join. Ch 1. (42)",
    "joined rounds"
  );
  testSuccessful *= displayFailedTest(
    "Generate first row",
    generateFirstRow(42, sc, true)[1] ===
      "Magic ring, 42 single crochet, join. Chain 1. 42 stitches total.",
    "joined rounds"
  );
  testSuccessful *= displayFailedTest(
    "Generate first row",
    generateFirstRow(42, sc, false)[0] === "Magic ring, 42 sc. (42)",
    "continuous rounds"
  );
  testSuccessful *= displayFailedTest(
    "Generate first row",
    generateFirstRow(42, sc, false)[1] ===
  ...
  testSuccessful *= displayFailedTest(
    "Generate middle row",
    generateMiddleRow(16, 13, sc, false, false, true)[0] ===
      "*3 sc, 1 inc* ×3, 1 sc, join. Ch 1. (16)",
    "increase row, joined rows"
  );
  testSuccessful *= displayFailedTest(
    "Generate middle row",
    generateMiddleRow(16, 13, sc, false, false, true)[1] ===
  ...
  testSuccessful *= displayFailedTest(
    "Generate middle row",
    generateMiddleRow(13, 16, sc, false, false, true)[0] ===
      "*3 sc, 1 dec* ×3, 1 sc, join. Ch 1. (13)",
    "decrease row, joined rows"
  );
  testSuccessful *= displayFailedTest(
    "Generate middle row",
    generateMiddleRow(13, 16, sc, false, false, true)[1] ===
  ...
  testSuccessful *= displayFailedTest(
    "Generate middle row",
    generateMiddleRow(13, 16, sc, false, false, false)[0] ===
      "*3 sc, 1 dec* ×3, 1 sc. (13)",
    "decrease row, continuous rows"
  );
  testSuccessful *= displayFailedTest(
    "Generate middle row",
    generateMiddleRow(13, 16, sc, false, false, false)[1] ===
      "3 single crochet, 1 decrease. Repeat from beginning of row 3 times, " +
  ...
  testSuccessful *= displayFailedTest(
    "Generate middle row",
    generateMiddleRow(10, 10, sc, false, false, false)[0] ===
      "Sc in every stitch. (10)",
    "no increases or decreases, continuous rows"
  );
  testSuccessful *= displayFailedTest(
    "Generate middle row",
    generateMiddleRow(10, 10, sc, false, false, false)[1] ===
  ...
  testSuccessful *= displayFailedTest(
    "Generate increase row",
    generateIncRow(16, 13, sc, true)[0] ===
      "*3 sc, 1 inc* ×3, 1 sc, join. Ch 1. (16)",
    "fewer inc than normal st, joined rounds"
  );
  testSuccessful *= displayFailedTest(
    "Generate increase row",
    generateIncRow(16, 13, sc, true)[1] ===
      "3 single crochet, 1 increase. Repeat from beginning of row 3 times, " +
        "1 single crochet, join. Chain 1. 16 stitches total.",
    "fewer inc than normal st, joined rounds"
  );
  testSuccessful *= displayFailedTest(
    "Generate increase row",
    generateIncRow(10, 5, sc, false)[0] === "Inc in every stitch. (10)",
    "all increases, continuous rounds"
  );
  testSuccessful *= displayFailedTest(
    "Generate increase row",
    generateIncRow(10, 5, sc, false)[1] ===
      "Increase in every stitch. 10 stitches total.",
    "all increases, continuous rounds"
  );
  testSuccessful *= displayFailedTest(
    "Generate increase row",
    generateIncRow(16, 10, sc, false)[0] === "*1 sc, 1 inc* ×4, 2 inc. (16)",
    "more inc than normal st, continuous rounds"
  );
  testSuccessful *= displayFailedTest(
    "Generate increase row",
    generateIncRow(16, 10, sc, false)[1] ===
      "1 single crochet, 1 increase. Repeat from beginning of row 4 times, " +
  ...
  testSuccessful *= displayFailedTest(
    "Generate increase row",
    generateIncRow(16, 13, sc, false)[0] === "*3 sc, 1 inc* ×3, 1 sc. (16)",
    "fewer inc than normal st, continuous rounds"
  );
  testSuccessful *= displayFailedTest(
    "Generate increase row",
    generateIncRow(16, 13, sc, false)[1] ===
      "3 single crochet, 1 increase. Repeat from beginning of row 3 times, " +
        "1 single crochet. 16 stitches total.",
    "fewer inc than normal st, continuous rounds"
  );
  ...
  testSuccessful *= displayFailedTest(
    "Generate decrease row",
    generateDecRow(13, 16, sc, false, false, true)[0] ===
      "*3 sc, 1 dec* ×3, 1 sc, join. Ch 1. (13)",
    "fewer dec than normal st, joined rounds"
  );
  testSuccessful *= displayFailedTest(
    "Generate decrease row",
    generateDecRow(13, 16, sc, false, false, true)[1] ===
      "3 single crochet, 1 decrease. Repeat from beginning of row 3 times, " +
        "1 single crochet, join. Chain 1. 13 stitches total.",
  ...
  testSuccessful *= displayFailedTest(
    "Generate decrease row",
    generateDecRow(13, 16, sc, false, true, true)[0] ===
      "*3 sc, 1 dec* ×3, 1 sc, join. (13)",
    "is last row, joined rounds"
  );
  testSuccessful *= displayFailedTest(
    "Generate decrease row",
    generateDecRow(13, 16, sc, false, true, true)[1] ===
      "3 single crochet, 1 decrease. Repeat from beginning of row 3 times, " +
  ...
  testSuccessful *= displayFailedTest(
    "Generate decrease row",
    generateDecRow(13, 16, sc, true, false, true)[0] ===
  ...
  testSuccessful *= displayFailedTest(
    "Generate decrease row",
    generateDecRow(13, 16, sc, true, false, true)[1] ===
      "3 single crochet, 1 decrease. Repeat from beginning of row 3 times, " +
  ...
  testSuccessful *= displayFailedTest(
    "Generate decrease row",
    generateDecRow(13, 16, sc, false, false, false)[0] ===
      "*3 sc, 1 dec* ×3, 1 sc. (13)",
    "fewer dec than normal st, continuous rounds"
  );
  testSuccessful *= displayFailedTest(
    "Generate decrease row",
    generateDecRow(13, 16, sc, false, false, false)[1] ===
      "3 single crochet, 1 decrease. Repeat from beginning of row 3 times, " +
        "1 single crochet. 13 stitches total.",
  ...
  testSuccessful *= displayFailedTest(
    "Generate decrease row",
    generateDecRow(13, 16, sc, false, true, false)[0] ===
      "*3 sc, 1 dec* ×3, 1 sc. (13)",
    "is last row, continuous rounds"
  );
  testSuccessful *= displayFailedTest(
    "Generate decrease row",
    generateDecRow(13, 16, sc, false, true, false)[1] ===
      "3 single crochet, 1 decrease. Repeat from beginning of row 3 times, " +
        "1 single crochet. 13 stitches total.",
  ...
  testSuccessful *= displayFailedTest(
    "Generate straight row",
    generateStraightRow(10, sc, false, false, true)[0] ===
      "Sc in every stitch, join. Ch 1. (10)",
    "not stuffing row, not last row, joined rounds"
  );
  testSuccessful *= displayFailedTest(
    "Generate straight row",
    generateStraightRow(10, sc, false, false, true)[1] ===
      "Single crochet in every stitch, join. Chain 1. 10 stitches total.",
    "not stuffing row, not last row, joined rounds, description"
  );
  testSuccessful *= displayFailedTest(
    "Generate straight row",
    generateStraightRow(10, sc, true, false, true)[0] ===
  ...
  testSuccessful *= displayFailedTest(
    "Generate straight row",
    generateStraightRow(10, sc, true, false, true)[1] ===
      "Single crochet in every stitch, join. Chain 1. 10 stitches total. " +
  ...
  testSuccessful *= displayFailedTest(
    "Generate straight row",
    generateStraightRow(10, sc, false, true, false)[0] ===
      "Sc in every stitch. (10)",
    "last row, continuous rounds"
  );
  testSuccessful *= displayFailedTest(
    "Generate straight row",
    generateStraightRow(10, sc, false, true, false)[1] ===
      "Single crochet in every stitch. 10 stitches total.",
